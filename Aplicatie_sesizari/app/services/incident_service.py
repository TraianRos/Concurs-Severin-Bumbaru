...
class IncidentService:
    ...
    def create_incident(self, payload: dict, files, current_user) -> dict:
        ...
        try:
            ...
            return {"ok": False, "message": "Alege un punct pe hartă pentru sesizare."}
        ...
        try:
            ...
            self.incident_repository.create_update(
                ...
                message="Sesizarea a fost trimisă și asteapta trierea inițială.",
            ...
            return {
                "ok": False,
                "message": "Fotografiile nu au putut fi salvate. Încearca din nou.",
            }
    ...
    def _reject_suggested_department(self, incident, payload, actor) -> dict:
        ...
        self.notification_repository.create_many(
            ...
            incident.id,
            f'Sugestia inițială de departament pentru sesizarea "{incident.title}" a fost retrimisă la triere.',
        )

        db.session.commit()
        return {"ok": True, "message": "Sugestia de departament a fost respinsă și cazul ramane în triere."}
    ...
    def _public_message_for_update(self, update, departments: dict[int, str]) -> str | None:
        if update.new_status == "in_triere" and update.old_status is None:
            return "Sesizarea a fost înregistrată și asteapta trierea inițială."
        ...
        if update.old_department_id is not None and update.new_department_id is None and update.new_status == update.old_status:
            return "Sugestia inițială de departament a fost retrimisă la triere."
